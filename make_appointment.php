...
$files = [
    'app/Livewire/AppointmentBooking.php' => <<<'EOT'
<?php
...
EOT,
    ...
    'resources/views/livewire/appointment-booking.blade.php' => <<<'EOT'
<div>
    @if($step < 4)
...
EOT,
    ...
    'resources/views/pages/appointment/index.blade.php' => <<<'EOT'
@extends('layouts.app')
...
echo "Appointment booking components created.\n";
