...
<body class="font-sans antialiased text-gray-800 bg-white overflow-x-hidden">
    ...
    @php
        $globalSettings = [
            'hospital_phone' => $siteSettings->get('contact_phone', '+252 615 666 999'),
        ...
        <div class="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-y-2">
            ...
            <div class="flex items-center gap-3 sm:gap-6 shrink-0">
                ...
                <span class="flex items-center gap-1.5">
                    ...
                    <span class="hidden sm:inline">{{ $globalSettings['hospital_phone'] }}</span>
                    <a href="tel:{{ preg_replace('/[^0-9+]/', '', $globalSettings['hospital_phone']) }}" class="sm:hidden hover:text-blue-200">{{ $globalSettings['hospital_phone'] }}</a>
                </span>
