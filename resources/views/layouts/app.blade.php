...
<body class="font-sans antialiased text-gray-800 bg-white overflow-x-hidden">
    ...
    <div class="bg-[#003B73] text-white text-xs md:text-sm font-medium py-2.5 px-4 border-b border-blue-800/30">
    ...
    <nav class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden xl:flex items-center gap-3 lg:gap-6">
                    <a href="/" class="flex flex-col items-center group {{ request()->is('/') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Home') }}</span>
                    </a>
                    <a href="/about" class="flex flex-col items-center group {{ request()->is('about') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('About Us') }}</span>
                    </a>
                    <div class="relative group flex flex-col items-center" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        <a href="/departments" class="flex flex-col items-center group {{ request()->is('departments*') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                            <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                            <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Services') }}</span>
                        </a>
                    ...
                    <a href="/doctors" class="flex flex-col items-center group {{ request()->is('doctors') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Doctors') }}</span>
                    </a>
                    <a href="/about" class="flex flex-col items-center group text-[#003B73] hover:text-[#0062B8] transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Patients & Visitors') }}</span>
                    </a>
                    <a href="/posts" class="flex flex-col items-center group {{ request()->is('posts*') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Blog') }}</span>
                    </a>
                    <a href="{{ route('careers.index') }}" class="flex flex-col items-center group {{ request()->is('careers*') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Careers') }}</span>
                    </a>
                    <a href="{{ route('offers.index') }}" class="flex flex-col items-center group {{ request()->is('offers*') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Offers') }}</span>
                    </a>
                    <a href="/contact" class="flex flex-col items-center group {{ request()->is('contact') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-6 h-6 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        <span class="text-xs lg:text-sm font-bold leading-tight whitespace-nowrap">{{ __('Contact') }}</span>
                    </a>
                </div>
        ...
        <div x-show="mobileMenuOpen" x-collapse x-cloak class="xl:hidden bg-white border-t border-gray-100 shadow-xl absolute w-full left-0 z-40">
            <div class="px-4 py-6 flex flex-col gap-4">
                ...
                <a href="{{ route('careers.index') }}" class="text-base font-bold {{ request()->is('careers*') ? 'text-[#0062B8]' : 'text-gray-800' }}">{{ __('Careers') }}</a>
                <a href="{{ route('offers.index') }}" class="text-base font-bold {{ request()->is('offers*') ? 'text-[#0062B8]' : 'text-gray-800' }}">{{ __('Offers') }}</a>
