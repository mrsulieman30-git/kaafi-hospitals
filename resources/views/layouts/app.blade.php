            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden xl:flex items-center gap-3 lg:gap-6">
                    ...
                    <a href="{{ route('careers.index') }}" class="flex flex-col items-center group {{ request()->is('careers*') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-5 h-5 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        <span class="text-[11px] lg:text-xs font-bold leading-tight whitespace-nowrap">{{ __('Careers') }}</span>
                    </a>
                    <a href="{{ route('offers.index') }}" class="flex flex-col items-center group {{ request()->is('offers*') ? 'text-[#0062B8]' : 'text-[#003B73] hover:text-[#0062B8]' }} transition">
                        <svg class="w-5 h-5 mb-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                        <span class="text-[11px] lg:text-xs font-bold leading-tight whitespace-nowrap">{{ __('Offers') }}</span>
                    </a>
