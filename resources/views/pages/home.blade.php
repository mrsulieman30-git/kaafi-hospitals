        ...
        <div class="relative max-w-7xl mx-auto h-full flex flex-col justify-center px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl">
                <h1 class="text-5xl tracking-tight font-extrabold text-[#003B73] sm:text-6xl lg:text-7xl">
                    ...
                    <span class="block text-[#003B73]">Our Priority</span>
                </h1>
                <p class="mt-4 text-lg text-gray-700 sm:max-w-xl">
                    Kaafi Hospitals is committed to providing compassionate, high-quality healthcare for you and your family.
                </p>
                <div class="mt-8 flex flex-col sm:flex-row gap-4">
                    <a href="/appointment" class="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-lg text-white bg-[#0062B8] hover:bg-blue-700 transition shadow-lg">
                        ...
                        <div class="flex flex-col text-left">
                            <span class="text-base font-bold leading-tight">Book Appointment</span>
                            <span class="text-xs text-blue-100 font-medium">Qabso Ballan</span>
                        </div>
                    </a>
                    <a href="/departments" class="inline-flex items-center justify-center px-6 py-3 border border-[#0062B8] rounded-lg text-[#0062B8] bg-white hover:bg-blue-50 transition shadow-lg">
                        ...
                        <div class="flex flex-col text-left">
                            <span class="text-base font-bold leading-tight">Our Services</span>
                            <span class="text-xs text-gray-500 font-medium">Adeegyada</span>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white shadow-xl relative z-20 -mt-12 mx-4 md:mx-auto max-w-6xl rounded-2xl p-6 md:p-8 border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            <div class="flex items-center justify-center md:justify-start px-4">
                ...
                <div class="ml-4">
                    <h3 class="text-sm font-bold text-gray-900 leading-tight">Trusted Care</h3>
                    <p class="text-[0.65rem] text-gray-500 font-medium">Daryeel Lagu Kalsoon Yahay</p>
                </div>
            </div>
            <div class="flex items-center justify-center md:justify-start px-4 pt-4 md:pt-0">
                ...
                <div class="ml-4">
                    <h3 class="text-sm font-bold text-gray-900 leading-tight">Expert Doctors</h3>
                    <p class="text-[0.65rem] text-gray-500 font-medium">Dhakhaatiir Khibrad Leh</p>
                </div>
            </div>
            <div class="flex items-center justify-center md:justify-start px-4 pt-4 md:pt-0">
                <div class="flex-shrink-0 text-[#0062B8]">
                ...
                <div class="ml-4">
                    <h3 class="text-sm font-bold text-gray-900 leading-tight">Advanced Technology</h3>
                    <p class="text-[0.65rem] text-gray-500 font-medium">Teknooloji Casri Ah</p>
                </div>
            </div>
            <div class="flex items-center justify-center md:justify-start px-4 pt-4 md:pt-0">
                <div class="flex-shrink-0 text-[#0062B8]">
                ...
                <div class="ml-4">
                    <h3 class="text-sm font-bold text-gray-900 leading-tight">24/7 Emergency</h3>
                    <p class="text-[0.65rem] text-gray-500 font-medium">Degdeg 24/7 Ah</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
                    Our team of experienced medical professionals is dedicated to providing you with the best possible care.
                </p>
            </div>
            ...
            <div class="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition transform hover:-translate-y-1">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-[#0062B8] font-medium mt-1">{{ $doctor->title }}</p>
                        
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <a href="/doctors/{{ $doctor->slug }}" class="text-[#0062B8] hover:text-blue-800 font-semibold flex items-center">
                                View Profile <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                            </a>
                        </div>
                    </div>
                </div>
